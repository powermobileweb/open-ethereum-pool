...
* [Ether-Proxy](https://github.com/p/ether-proxy) HTTP proxy with web interface
...
Clone & compile:
    ...
    git clone https://github.com/powermobileteam/open-ethereum-pool.git
...
BTC: 17ud4Qb7p5mF1yzNZk44V6vFt5Lmj9pgr6
